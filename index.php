            ...
            <div class="container">
                <div class="wrapper">
                    <form action="index.php?method=login&continue_login=true" method="post" class="navbar-form navbar-left">
                        ...
                        <button type="submit" value="Login" name="Submit" class="btn btn-lg btn-primary btn-block" />Login</button>
                    </form>

                    <a class="btn btn-link" href="index.php?method=register">Registrieren</a>
                </div>
            </div>
